...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iwJiV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "gaEventsCF7", ()=>gaEventsCF7);
const gaEventsCF7 = ()=>{
    document.addEventListener("wpcf7mailsent", (event)=>{
        ...
        Array.from(event.detail.inputs).forEach((item)=>{
            if (item.name == "client_phone") clientPhone = item.value;
            if (item.name == "client_email") clientMail = item.value;
        });
