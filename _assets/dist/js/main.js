...
var _formInputs = require("./form_inputs");
(0, _utils.ready)(()=>{
    (0, _menu.mainMenu)();
    ...
    btnMoreEducation();
    initFAQ();
    (0, _formInputs.coloredBorderOnFirstInput)();
});
...
},{"./utils":"blFj3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3pM6z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "coloredBorderOnFirstInput", ()=>coloredBorderOnFirstInput);
const coloredBorderOnFirstInput = ()=>{
    let formsSelector = document.querySelectorAll("form.wpcf7") ? Array.from(document.querySelectorAll("form.wpcf7")) : false;
    if (formsSelector.length > 0) Array.from(formsSelector).forEach((item, index)=>{
        let inputsInsideForm = item.querySelectorAll(".wpcf7-form-control");
        Array.from(inputsInsideForm).forEach((el, indx)=>{
            if (indx == 0) el.classList.add("border-yellow-input");
        });
        Array.from(inputsInsideForm).forEach((el, indx)=>{
            [
                "click",
