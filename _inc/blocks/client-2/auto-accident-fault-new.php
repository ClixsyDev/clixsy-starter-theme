...
function register_auto_accident_fault_new() {
    if (function_exists('acf_register_block_type')) {
        acf_register_block_type(
            array(
                'name'            => 'Auto accident fault New',
                'title'           => __('Auto accident fault New', 'clixsy'),
                'description'      => __('Design v1.', 'clixsy'),
                'render_template' => '_template-parts/guttenberg-extend-templates/client-2/auto-accident-fault-new.php',
                'icon'            => 'groups',
                'category'        => 'clixsy',
...
add_action('acf/init', 'register_auto_accident_fault_new');

if (function_exists('acf_add_local_field_group')) :
    $block_key = 'auto_accident_fault_new__';
            ...
            'location' => array(
                array(
                    array(
                        'param' => 'block',
                        'operator' => '==',
                        'value' => 'acf/auto-accident-fault-new',
                    ),
                ),
            ),
            'fields' => array(
