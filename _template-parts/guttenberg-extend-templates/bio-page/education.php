<div class="pt-16 pb-28">
    <div class="container">
        <h2 class="text-headings_second font-medium text-4xl text-center leading-tight pb-4">Education</h2>
