    ...
    <div class="container h-full absolute left-0 right-0 top-0  mx-auto ">
        <div class=" translate-y-[20%] 2xl:translate-y-[30%] lg:translate-y-[20%] md:translate-y-[35%]">
            ...
            <div class="w-full flex justify-center ">
                <a href="#" class="text-white bg-accent w-[580px] 2xl:w-[300px] h-20 flex justify-center items-center text-4xl  xxl:text-2xl  font-bold rounded-full">FREE CASE REVIEW</a>
            </div>
        </div>
    </div>
</section>
...
<section class="relative pt-8 mb-16">
    <div class=" text-headings text-4xl text-center relative pb-16">
        <h2 class="font-bold"><span class=" text-accent">Kenny has won MILLIONS</span> for his clients</h2>
                ...
                <div class="w-[90%] md:w-full mx-auto">
                    <div class="mb-8">
                        <div class=" 2xl:pl-5 py-9 text-white text-3xl 2xl:text-xl font-bold">
                            <p>That’s why our top priority is taking care of our clients throughout the <span class=" text-headings"> entire process</span> at every step. From filing your claim, negotiating the best possible settlement amount, or representing you in court – <span class=" text-headings">we have 24/7 access to your case from start to finish.</span></p>
                        </div>
                    </div>
                    <div class="w-full flex justify-center mb-16">
                        <a href="#" class="text-white bg-accent w-[490px] 2xl:w-[300px] h-20 flex justify-center items-center text-2xl  font-bold rounded-full">FREE CASE REVIEW</a>
                    </div>
                </div>
            </div>
        </div>
    <?php } else { ?>
        <div class="container flex">
            <div class="w-[65%] 2xl:w-[55%] relative">
                ...
                <div class="w-full flex justify-center">
                    <a href="#" class="text-white bg-accent w-[490px] 2xl:w-[300px] h-20 flex justify-center items-center text-4xl 2xl:text-2xl font-bold rounded-full">FREE CASE REVIEW</a>
                </div>
...
<section class="container mb-16">
    <div class=" text-headings text-4xl text-center relative pb-16">
        <h2 class="font-bold"><span class=" text-accent">What to do</span> after the accident</h2>
        <span class="bg-accent w-32 h-1 absolute left-0 right-0 mx-auto"></span>
    </div>
        ...
        <div class="w-[60%] lg:w-full text-[40px] font-avenir text-headings leading-none">
            <div class=" bg-[#F3F3F3]">
                <div class="flex  items-center lg:justify-start py-9 pl-5 h-64 lg:h-40 lg:w-3/5 md:w-full lg:mx-auto">
                    ...
                    <div class=" text-[40px] lg:text-[25px] ">
                        <p class="pb-2">Call us for <span class="text-accent font-bold">FREE</span> initial case review.</p>
                        <p class="font-bold pb-2">855-GO-KENNY</p>
                        <a href="#" class="text-white bg-accent w-1/3 lg:w-1/2 h-11 flex justify-center items-center text-2xl font-bold rounded-full">Call Now</a>
                    </div>
                </div>
            </div>
            <div class="bg-[#A5ACAF]">
                <div class="flex  text-white  items-center lg:justify-start lg:w-3/5 lg:mx-auto md:w-full py-9 pl-5 h-64 lg:h-40">
                    ...
                    <div class=" text-[40px] lg:text-[25px] ">
                        <p>We get to <span class=" text-headings font-bold">WORK</span> on your case</p>
                    </div>
                </div>
            </div>
            ...
            <div class=" bg-[#F3F3F3]">
                <div class="flex   items-center lg:justify-start lg:w-3/5 lg:mx-auto md:w-full py-9 pl-5 h-64 lg:h-40">
                    ...
                    <div class=" text-[40px] lg:text-[25px] ">
                        <p>Our team will <span class="text-accent font-bold">FIGHT</span> to get you the settelment you deserve</p>
                    </div>
                </div>
            </div>
    ...
    <div class="w-full text-headings">
        <div class=" text-white text-5xl xl:text-4xl lg:text-3xl md:text-2xl text-center relative pb-16 pt-28">
            <h2 class="font-bold">We only get paid if we <span class=" text-accent">WIN your Case</span></h2>
            <span class="bg-accent w-32 h-1 absolute left-0 right-0 mx-auto"></span>
        </div>
        ...
        <div class="w-full flex justify-center pb-16"> <a href="#" class="text-white bg-accent w-96 lg:w-72 h-20  flex justify-center items-center text-4xl lg:text-2xl font-bold rounded-full">CONTACT US</a></div>
    </div>
</section>
...
<section class="container mb-16">
    <div class=" text-headings text-4xl text-center relative pb-16">
        <h2 class="font-bold">Car Accident <span class=" text-accent">FAQ's</span></h2>
        <span class="bg-accent w-32 h-1 absolute left-0 right-0 mx-auto"></span>
    </div>
...
<section class="contact-page__hero-wrapper " style="background-image: url(<?php echo get_template_directory_uri() ?>/_assets/src/img/contact-page-bg.png);">
    <div class="contact-page__hero__img-wrapper">
        ...
        <div class="contact-page__form contact-page__hero__form-wrapper">
            <h2 class="text-white text-center text-[40px] mdt:text-4xl md:text-[28px] sm:text-2xl my-10 sm:my-5">How can Kenny <span class="text-accent">help?</span> </h2>
...
<section class="w-full bg-img-case-types pt-32 pb-20 font-avenir">
    <div class="container">
        ...
        <div class="flex flex-row mdt:flex-wrap justify-center w-full">
            <div class="text-headings text-4xl mdt:text-2xl mx-auto w-full  order-1 mdt:order-2 ">
