        ...
        <div class="container flex items-end xl:max-w-full md:flex-wrap md:flex-col">
            <div class="w-[65%] lg:w-full relative">
                <h2 class="font-main font-bold absolute right-4 top-40 text-[60px] text-right leading-tight max-w-[367px] 
                    2xl:text-[40px] 2xl:max-w-[280px] md:top-0 sm:text-[30px] sm:max-w-[200px] transorm lg:-translate-y-16 lg:text-3xl md:text-5xl md:translate-y-0"><?= $title ?></h2>
                ...
                <div class="absolute items-end bottom-0 left-0 lg:-left-16 md:left-0 w-full h-72 z-30 flex pt-9 px-5 pb-3 md:justify-between">
                    <div class="flex items-end justify-between md:justify-end sm:justify-evenly sm:item-center w-full">
                        ...
                        <?php if ($state_name) { ?>
                            <div class="font-main text-white text-10xl leading-tight mb-6 2xl:text-8xl xl:text-5xl md:text-4xl sm:text-2xl transform sm:translate-y-8"><?= $state_name ?></div>
                        <?php } ?>
                    </div>
                </div>
            </div>
