<div class="py-16 background-image ">
    <div class="container">
        ...
        <div class="mt-16 xl:mt-9">
            <h3 class="font-bold text-2xl text-center mdt:text-xl">Local organizations Habetz Law supports:</h3>
                ...
                <div class="glide__track" data-glide-el="track">
                    ...
                    <div class="text-center relative mt-10 xs:mt-6">
                        ...
                        <div class="glide__bullets" data-glide-el="controls[nav]">
                            <button class="slider__bullet glide__bullet focus:border-none bg-kennySmoke focus:bg-darkOrange hover:bg-darkOrange w-7 h-1.5 rounded-none xs:h-1.5 xs:w-8" data-glide-dir="=0"></button>
                            <button class="slider__bullet glide__bullet focus:border-none bg-kennySmoke focus:bg-darkOrange hover:bg-darkOrange w-7 h-1.5 rounded-none xs:h-1.5 xs:w-8" data-glide-dir="=0"></button>
                            <button class="slider__bullet glide__bullet focus:border-none bg-kennySmoke focus:bg-darkOrange hover:bg-darkOrange w-7 h-1.5 rounded-none xs:h-1.5 xs:w-8" data-glide-dir="=0"></button>
                        </div>
