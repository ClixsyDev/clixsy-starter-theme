<div class="pb-16">
    <div class="container">
        <h2 class="text-headings font-medium text-5xl text-center leading-tight pb-4 lg:text-4xl md:text-3xl xs:text-2xl">Habetz Injury Law we are dedicated to the <br> <span>3 C’s of Customer Service</span></h2>
