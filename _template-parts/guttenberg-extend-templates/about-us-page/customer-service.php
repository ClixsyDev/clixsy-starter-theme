<div class="pb-16">
    <div class="container">
        <h2 class="text-kennyBlue font-medium text-5xl text-center leading-tight pb-4 lg:text-4xl md:text-3xl xs:text-2xl">Habetz Injury Law we are dedicated to the <br> <span>3 C’s of Customer Service</span></h2>
        ...
        <div class="flex justify-center mt-48 gap-12 xl:gap-6 mdt:flex-col mdt:gap-44 mdt:mt-36 xs:gap-36">
            <div class="bg-kennyBlueSecond text-center px-5 w-6/24 pb-6 xl:w-18/24 mdt:m-auto mdt:w-16/24 xs:w-21/24">
                ...
                <h3 class="text-kennyGreen text-2xl font-noto_serif my-3">
                    Clear <br> Process
                </h3>
