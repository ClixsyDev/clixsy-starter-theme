<div class="pt-20 pb-24 xs:pb-16">
    <div class="container md:p-0">
            ...
            <div class="flex flex-col w-18/24 md:w-full md:-mt-[15px]">
                <div class="bg-process_smoke min-h-[246px] flex gap-5 px-5 py-12 xl:py-8 xl:min-h-[195px] xl:items-center lg:min-h-max md:px-20 xs:px-6 xs:py-5">
                    ...
                    <div class="text-4xl font-main xl:text-3xl lg:text-2xl xs:text-xl">
                        ...
                        <p class="uppercase text-headingsThird font-bold font-main">855-GO-KENNY</p>
                        <div class="">
                            <a href="#" class="font-main bg-accent text-white font-bold text-2xl py-2 px-12 rounded-full lg:px-8 lg:py-2 lg:text-lg xs:text-lg xs:py-1">Call Now</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-center mt-16 xs:mt-12">
            <a href="#" class="font-main uppercase bg-accent text-white font-bold text-2xl py-2 px-20 rounded-full lg:px-8 lg:py-3 lg:text-lg xs:text-xl">GO KENNY!</a>
        </div>
    </div>
</div>