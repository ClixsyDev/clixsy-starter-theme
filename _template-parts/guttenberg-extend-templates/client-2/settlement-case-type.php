...
if ($is_preview && !empty($previewImage)) {
    ...
    <section class="pt-48 pb-16 bg-cover relative -mt-28 xs:pt-36 lg:bg-top" style="background-image:url('<?php echo !empty($settlement_case_type__background_image) ? wp_get_attachment_image_url($settlement_case_type__background_image['ID'], 'full') : ''; ?>');">
