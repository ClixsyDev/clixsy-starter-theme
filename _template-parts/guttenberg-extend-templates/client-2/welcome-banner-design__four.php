        ...
        <?php if ($welcome_banner__design_four_title || $welcome_banner__design_four_logo || $welcome_banner__design_four_subtitle) { ?>
            <div class="container text-center">
                <?php if ($welcome_banner__design_four_subtitle) { ?>
                    <h2 class="text-button_color font-semibold text-[41px] pb-0 tracking-widest lg:!text-2xl xl:pb-0 sm:!text-lg " data-aos="fade-up" data-aos-easing="ease-in" data-aos-duration="700" data-aos-iteration="infinite" data-aos-delay="1000"><?php echo $welcome_banner__design_four_subtitle ?></h2>
                <?php } ?>
                <?php if ($welcome_banner__design_four_title) { ?>
                    <?php echo '<' . $welcome_banner__banner_heading_tag . ' class="hero_heading_h1 banner !leading-none revealUp" data-aos="fade-up" data-aos-easing="ease-in" data-aos-duration="1000" data-aos-iteration="infinite data-aos-delay="1000"">' . $welcome_banner__design_four_title . '</' . $welcome_banner__banner_heading_tag . '>'; ?>
                <?php } ?>
                <?php if ($welcome_banner__design_four_info) { ?>
                    <h2 class="text-button_color font-semibold text-3xl pb-12 tracking-widest lg:!text-2xl xl:pb-0 sm:!text-lg" data-aos="fade-up" data-aos-easing="ease-in" data-aos-duration="1200" data-aos-iteration="infinite" data-aos-delay="1000"><?php echo $welcome_banner__design_four_info ?></h2>
                <?php } ?>
