        ...
        <div class=" mt-11 flex justify-center gap-11 md:flex-col md:items-center md:gap-4 md:w-full ">
            <?php if ($button1) { ?>
                ...
                Template::load('_template-parts/components/button.php', [
                    ...
                    'text_hover' => false,
                    'classes' => 'btn_sm bigauto_red !max-w-[460px] rounded-xl md:w-4/5 xs:shadow-btn', // hover_headings hover_accent hover_white btn_headings btn_xl btn_md btn_sm
                ]); ?>
            <?php } ?>
            <?php if ($button2) { ?>
                <?php
                Template::load('_template-parts/components/button.php', [
                    ...
                    'text_hover' => false,
                    'classes' => 'btn_sm bg-white transparent !text-button_color hover:!text-white hover_accent !max-w-[460px] rounded-xl md:w-4/5 xs:shadow-btn', // hover_headings hover_accent hover_white btn_headings btn_xl btn_md btn_sm
                ]); ?>
            <?php } ?>
        </div>
    </div>
