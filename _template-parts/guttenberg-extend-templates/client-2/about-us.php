                                ...
                                <div class="glide__slides">
                                    <?php foreach ($about_us__video_id_repeater as $key => $item) { ?>
                                        <div class="glide__slide">
                                            <div data-yt-url="<?php echo $key ?>" class="bg-center relative mt-48 lg:mt-[15%] h-[15vw] lg:h-[380px] sm:h-auto min-h-[250px]  max-h-72 bg-cover fireTestimonialModal"  style="background-image: url('http://img.youtube.com/vi/<?php echo $item['video_id'] ?>/hqdefault.jpg');">
