...
?>
    <section class="pt-40  -mb-[4%] lg:-mb-[6%] 2xl:pt-44 md:pt-28 relative z-[1] lg:!pt-8">
        <div class="container">
            ...
            <?php } ?>
            <div class="flex pb-8 px-9 gap-16 lg:gap-8 items-center max-h-96  2xl:pt-8 lg:flex-col lg:max-h-max lg:mb-8 md:gap-8 lg:p-0" style="background-color: <?php echo $about_us__block_color ?: ''  ?> ;">
                ...
                <?php if ($about_us__first_description) { ?>
                    <div class="w-12/24 mt-10 lg:w-20/24 lg:mt-2">
                        ...
                        <div class="text-white text-6xl xs:!text-4xl font-second font-bold"> <?php echo $about_us__number ?></div>
                    </div>
                <?php } ?>
            </div>
        </div>
