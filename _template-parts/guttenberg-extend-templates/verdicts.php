<div class="relative">
    ...
    <div class="relative flex justify-center gap-5 px-5 pt-12 pb-14">
        <div class="bg-white pt-4 pb-2 px-4 text-center flex-1">
            <div class="text-kennyGreen text-5xl leading-none">
                $2.25 MILLION
            </div>
            <div class=" text-[40px] ">
                Maritime accident
    ...
    <div class="container relative pb-16 pt-10">
        <div class="google_reviews_slider flex gap-12">
            <div class="slider_item flex-1 bg-white relative pt-9 px-8 pb-36">
                ...
                <div class="text-lg leading-tight mb-6 text-kennyGrayText">
                    Hiring a lawyer can sometimes be overwhelming. Having someone who genuinely cares about you is hard to come by these days but Kenny Habetz is one of the only lawyers I completely trust. He constantly demonstrates high standards and character rarely seen in business today. He is extremely intelligent, passionate, hardworking and will get the job done.
                </div>
                <div class=" font-bold text-kennyGrayText">-Suni M.</div>
                <div>
